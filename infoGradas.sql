DROP PROCEDURE IF EXISTS infoGradas;

delimiter //
CREATE PROCEDURE infoGradas(IN espectaculo int, IN recinto int, IN fecha datetime, IN grada int)
BEGIN
...
CALL infoGradas(1,1,'16-05-12 16:00:00',1);
